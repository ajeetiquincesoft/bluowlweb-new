                        ...
                        <div class="col-lg-12">
                            <div id="teamlist">
                                <div class="team-list grid-view-filter row" id="team-member-list">
                                                            ...
                                                            <div class="col text-end dropdown"> <a
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><a class="dropdown-item edit-list"
                                                                            href="#addmemberModal" data-bs-toggle="modal"
                                                                            data-edit-id="12"><i
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Team Leader
                                                                    &amp;
                                                                    HR</p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-12.jpg"
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Full Stack
                                                                    Developer</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-11.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Project
                                                                    Manager
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-1.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">UI/UX
                                                                    Designer
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-10.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-2.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Backend
                                                                    Developer
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-4.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Front-End
                                                                    Developer</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-7.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-3.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Web Designer
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-5.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">Wed Developer
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-8.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            ...
                                                            <div class="team-content"> <a class="member-name"
                                                                ...
                                                                <p class="text-muted member-designation mb-0">React Js
                                                                    Developer</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover"> <img src="assets/images/small/img-6.jpg"
                                                    alt="" class="img-fluid"> </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    <div class="col team-settings">
