        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        data-toggle="fullscreen" title="Full Screen">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a href="{{ route('logout') }}"
                        ...
                        class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle light-dark-mode"
                        title="Log Out">
                        <i class="las la-power-off" style="font-size: x-large;"></i>
                    </a>
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ Auth::user()->name }}
                                </span>
                                <span
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        {{-- <a class="dropdown-item" href="{{ route('contact_us') }}"><i
