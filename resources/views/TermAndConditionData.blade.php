                            ...
                            <div class="modal fade" id="varyingcontentModal" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('UpdateTermAndCondition') }}" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control summernote" name="content" id="message-text" rows="4">
                                                        {!! $data->content ?? '<p><em>No content available</em></p>' !!}
                                                    </textarea>
                                                </div>
